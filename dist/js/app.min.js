...
$(document).ready(function(){function a(){$("#formEspecifica").fadeOut("fast"),$("#formUniforme").fadeOut("fast"),$("#formCategorica").fadeOut("fast")}$("#rootwizard").bootstrapWizard(),$("#valor").rating(),$("#valorA").rating(),$("#varEspecifica").click(function(){a(),console.log("var especifca"),$("#formEspecifica").fadeIn()}),$("#varUniforme").click(function(){a(),console.log("var uniforme"),$("#formUniforme").fadeIn()}),$("#varCategorica").click(function(){a(),console.log("var categorica"),$("#formCategorica").fadeIn()})});
